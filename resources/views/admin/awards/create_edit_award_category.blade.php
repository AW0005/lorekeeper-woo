...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Badge Categories' => 'admin/data/award-categories', ($category->id ? 'Edit' : 'Create').' Category' => $category->id ? 'admin/data/award-categories/edit/'.$category->id : 'admin/data/award-categories/create']) !!}
