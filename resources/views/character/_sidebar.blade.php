<ul>
    ...
    <li class="sidebar-section">
        ...
        <!--Removing Galleries:  <div class="sidebar-item"><a href="{{ $character->url . '/gallery' }}" class="{{ set_active('character/'.$character->slug.'/gallery') }}">Gallery</a></div> -->
        ...
        <!-- <div class="sidebar-item"><a href="{{ $character->url . '/awards' }}" class="{{ set_active('character/'.$character->slug.'/awards') }}">Badges</a></div> -->
    </li>
    <li class="sidebar-section">
        ...
        <!-- <div class="sidebar-item"><a href="{{ $character->url . '/award-logs' }}" class="{{ set_active('character/'.$character->slug.'/award-logs') }}">Badge Logs</a></div> -->
    </li>
    @if(Auth::check() && (Auth::user()->id == $character->user_id || Auth::user()->hasPower('manage_characters')))
        <li class="sidebar-section">
            ...
            @if(Auth::user()->id == $character->user_id)
                <div class="sidebar-item"><a href="{{ $character->url . '/approval' }}" class="{{ set_active('character/'.$character->slug.'/approval') }}">Add / Update Form</a></div>
            @endif
        </li>
    @endif
</ul>
